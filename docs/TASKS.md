...
| Session | Owned paths                                                                                                                                                                                 | Dependency                           | Acceptance criteria                                                                                                            | Status                                                                                 | Updated    |
| ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------- | ---------- |
| opus-w1 | Slice 1-DB: `supabase/migrations/0035_provider_ledger_service_only.sql`, `supabase/tests/audit3/c02*·c03*`, `supabase/tests/audit2/b07*·b08*`(계약 갱신), audit3 README                     | Slice 0 승인                         | c02/c03 red→green, authenticated 직접 reserve/reconcile 거부, 동시 요청 단일 provider call, 보수적 실패 회계, revision binding | 진행 중                                                                                | 2026-07-14 |
| opus-w2 | Slice 1-Web: `apps/web/src/lib/providerBudget.ts`, `apps/web/app/api/{transcribe,moderate-text,media/validate}/**`, 웹 interest 플로우 own_content 동의 UI, 웹 라우트 테스트                | W1과 C1 계약 공유                    | 무동의 시 provider 호출 0회(구조 검사만), replay는 저장 verdict 재사용, 실패는 보수적 회계, adapter spy 테스트                 | 진행 중                                                                                | 2026-07-14 |
| opus-w3 | Slice 1-Mobile: `apps/mobile/src/**`(draft 생성/업로드 분리, 동의 선행, manual 무 AI, interested own_content 동의), 모바일 테스트                                                           | W1·W2와 C1/C2 계약 공유              | AI 경로에서 consent가 첫 업로드·검증보다 선행(스파이 증명), write_manually 경로 외부 AI 0회, 서버 revision 사용                | 진행 중                                                                                | 2026-07-14 |
