...
| Advisor | Slice 1: `packages/data/src/database.types.ts` RPC 계약 갱신, 루트/CI audit3 웹 편입, 문서 truth reset(README·COST_MODEL·DECISIONS·SESSION_HANDOFF), hosted 0035 배포·드릴                  | W1·W2·W3                             | 전체 게이트 그린 재실행, hosted에서 authenticated 직접 RPC 거부 드릴, 프로덕션 E2E                                             | 진행 중                                                                                                                  | 2026-07-14 |
